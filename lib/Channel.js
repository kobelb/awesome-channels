...
var Channel = (function () {
  ...
  _createClass(Channel, [{
    ...
    key: 'callWithTimeout',
    value: function callWithTimeout(methodName, cb, timeout) {
      var _this = this;
      ...
      var instanceId = this.call(methodName, function (response) {
        cb.apply(null, [true, response]);
      }, args);

      setTimeout(function () {
        if (_this._methodCallbacks[instanceId]) {
          delete _this._methodCallbacks[instanceId];
          cb(false);
        }
      }, timeout);
    }
