...
/***/ function(module, exports, __webpack_require__) {
	...
	var Channel = (function () {
	  _createClass(Channel, [{
	    ...
	    value: function _propagateMessage(message) {
	      var _this = this;

	      Array.prototype.forEach.call(this._getIframes(), function (iframe) {
	        iframe.contentWindow.postMessage(message, _this._targetOrigin);
	      });
	  ...
	  _createClass(Channel, [{
	    ...
	    value: function trigger(message) {
	      ...
	      Array.prototype.forEach.call(this._getIframes(), function (iframe) {
	        iframe.contentWindow.postMessage(payload, _this2._targetOrigin);
	      });
